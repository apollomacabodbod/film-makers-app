...
export default function BlogHeroSection(){
  ...
  return(<>
    ...
    <div className="z-20 lex flex-col mt-[13.0625em] mb-[6.875em]  transition-all duration-1000 ease-in-out">
      ...
      <motion.div className="flex items-baseline justify-center gap-[1.25em] transiton-all duration-1000 ease-in-out mt-[1em]"
      ...
      >
        ...
        <p className="font-roboto-condensed text-[0.875rem] not-italic font-bold uppercase text-white">Blog</p>
