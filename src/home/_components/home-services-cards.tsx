      ...
      <div className="grid grid-cols-1 sm3:grid-cols-2 lg:grid-cols-3  gap-[1.875em] mt-[3.125em]">
        ...
        {cards.map((item) => (
          ...
          >
            ...
            <div className="px-[1.25em] relative bg-center bg-no-repeat bg-cover w-full  xs:top-[16.1em] xs10:top-[16.9em] xs1:top-[16.9em]  sm:top-[16.9em] sm3:top-[16.1em] md1:top-[16.9em] md2:top-[16.9em] lg:top-[15.7em] xl:top-[15em]  pb-[0.9375em] "
