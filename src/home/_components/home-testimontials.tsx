...
export default function HomeTestimontials(){
  ...
  return (<>
    ...
    <div className="flex flex-col xl:px-[5.5em] lg:px-[2.75em] px-[1.25em] transition-all duration-1000 ease-in-out mt-[6.25em]">
      ...
      <p className='text-white font-roboto-condensed text-[4.5rem] not-italic font-bold '>What People Says?</p>
