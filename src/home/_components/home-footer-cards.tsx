...
export default function HomeFooterCards(){
  ...
  return (<>
    ...
    <div className="flex flex-col ">
      ...
      <div className="sm1:flex sm1:items-center sm1:justify-between gap-[3.125em] w-full">
        ...
        <div className="flex flex-col mt-[1em]">
          ...
          <p className="text-[#82869A] font-inter text-[1rem] not-italic font-normal whitespace-nowrap">Movie production</p>
        ...
        <div className="flex flex-col max-w-[16.4375em] mt-[1.5em]">

          <p className="text-white font-roboto-condensed text-[1.25rem] not-italic font-bold ">Quick links</p>

          <p className="text-[#82869A]  font-inter text-[1rem] not-italic font-normal">About</p>
        ...
        <div className="flex flex-col max-w-[16.4375em] mt-[1.5em]">
          ...
          <p className="text-[#82869A]  font-inter text-[1rem] not-italic font-normal whitespace-nowrap">Help center</p>
