      ...
      <div className="lg:flex lg:items-center lg:justify-between">
        ...
        <div className="flex flex-col mt-[1em] lg:mt-[0em]">
          ...
          <div className="sm3:flex sm3:items-baseline">
            ...
            <motion.button className="mt-[1em]  sm3:mt-[0em] py-[0.9em] px-[1.5625em] bg-[#FF5E3A] text-white rounded-[0.1875em] font-roboto-condensed text-[1rem] not-italic font-bold uppercase transtion-all duration-1000 ease-in-out"
