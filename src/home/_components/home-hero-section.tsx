    ...
    <div className=" max-w-[1200px] lg:mx-auto  px-[1.25em]  flex flex-col  z-10 my-[9em]  transition-all duration-1000 ease-in-out">
      ...
      <div className="lg:flex lg:items-center justify-between ">
        ...
        <div className="flex flex-col ">
          ...
          <motion.p className=" font-roboto-condensed text-[4rem] lg:text-[6rem] not-italic font-bold leading-[1em] lg:w-[8em] text-white  transition-all duration-1000 ease-in-out"
          ...
          <div className="flex items-center mt-[1.875em]">
            ...
            <div className="flex flex-col py-[1.0625em] px-[1.5625em] cursor-pointer ">
              ...
              >
                ...
                <img src="home-hero-section-play.svg" alt="" width={15} height={0} className="min-w-[0.8125em] mt-[-0.1em]  "/>
        ...
        {/* hide this second component */}
        <div className="lg:flex lg:flex-col hidden  opacity-0 ">



          <p className=" text-white ">
  
  Crafting unforgettable stories bringing their creative vision to life on the big screen - the movie maker director</p>
