  ...
  return(<>
    ...
    <div className="max-w-[1200px] lg:mx-auto z-20 lex flex-col mt-[13.0625em] mb-[6.875em]  transition-all duration-1000 ease-in-out">
      ...
      >
        ...
        <p className="text-[#FF5E3A] font-roboto-condensed text-[0.875rem] not-italic font-bold uppercase">Testimontials</p>
      ...
      >
        ...
        <p className="font-roboto-condensed text-[0.875rem] not-italic font-bold uppercase text-white">Testimontials</p>
