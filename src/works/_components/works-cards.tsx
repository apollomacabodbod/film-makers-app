...
export default function WorksCards(){
   ...
   const [data] = useState<HomeCards[]>([
     ...
     {id: 5 , title: "Documentary", description: 'Proin et magna blandit arcu pellentes sceleris ameta.', image: '/portrait-of-videographer.jpg',year: "2023"},
     {id: 6 , title: "Company Profile", description: 'Proin et magna blandit arcu pellentes sceleris ameta.', image: '/movie-clapper.jpg',year: "2023"},
     {id: 7 , title: "Documentary", description: 'Proin et magna blandit arcu pellentes sceleris ameta.', image: '/portrait-of-videographer.jpg',year: "2023"},
     {id: 8 , title: "Company Profile", description: 'Proin et magna blandit arcu pellentes sceleris ameta.', image: '/movie-clapper.jpg',year: "2023"},
   ])
