  ...
  return(<>
    ...
    <div className="z-20 lex flex-col mt-[13.0625em] mb-[6.875em]">
      ...
      >
        ...
        <p className="text-[#FF5E3A] font-roboto-condensed text-[0.875rem] not-italic font-bold uppercase">Our Porfolio</p>
      ...
      >
        ...
        <p className="font-roboto-condensed text-[0.875rem] not-italic font-bold uppercase text-white">Our Porfolio</p>
